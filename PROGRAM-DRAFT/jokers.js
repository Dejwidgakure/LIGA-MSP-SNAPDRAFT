/* ============================================================
   ...
   Version 3.23 — ARCHETYPE / PACKAGE TAG COVERAGE + RARE ARCHETYPE CUTS
...
const JOKER_CATALOG_VERSION = "3.23";
...
const jokers = [
  ...
  {
    "id": "choice_midrange_control",
    "type": "choice",
    "rarity": "epic",
    "family": "tag",
    "name": "Pakiet Kontrolny",
    "desc": "Dowolna karta · Kontrola Midrange",
    "sourceCategories": [
      "deckArchetypes"
    ],
    "filter": {
  ...
  {
    "id": "surprise_classic_destroy",
    "type": "surprise",
    "rarity": "epic",
    "family": "tag",
    "name": "Klasyczna Rzeź",
    "desc": "Losowa karta · Klasyczny Destroy",
    "sourceCategories": [
      "deckArchetypes"
    ],
    "filter": {
  ...
  {
    "id": "choice_move_combo",
    "type": "choice",
    "rarity": "epic",
    "family": "tag",
    "name": "Wielki Skok",
    "desc": "Dowolna karta · Combo Ruchu",
    "sourceCategories": [
      "deckArchetypes"
    ],
    "filter": {
  ...
  {
    "id": "choice_victoria_hand_big_hand",
    "type": "choice",
    "rarity": "epic",
    "family": "tag",
    "name": "Wielka Ręka",
    "desc": "Dowolna karta · Victoria Hand / Duża Ręka",
    "sourceCategories": [
      "deckArchetypes"
    ],
    "filter": {
  ...
  {
    "id": "surprise_galactus",
    "type": "surprise",
    "rarity": "epic",
    "family": "tag",
    "name": "Nadejście Pożeracza",
    "desc": "Losowa karta · Galactus",
    "sourceCategories": [
      "deckArchetypes"
    ],
    "filter": {
  ...
  {
    "id": "choice_darkhawk_ronan",
    "type": "choice",
    "rarity": "rare",
    "family": "tag",
    "name": "Ciemna Presja",
    "desc": "Dowolna karta · Darkhawk / Ronan",
    "sourceCategories": [
      "deckArchetypes"
    ],
    "filter": {
  ...
  ,{
    "id": "choice_mini_movers_low_cost",
    "type": "choice",
    "rarity": "rare",
    "family": "tag",
    "name": "Kieszonkowy Ruch",
    "desc": "Dowolna karta · Mini Movers · Koszt 1–2",
    "sourceCategories": [
      "deckArchetypes"
    ],
    "filter": {
  ...
  {
    "id": "choice_prio_control_low_cost",
    "type": "choice",
    "rarity": "rare",
    "family": "tag",
    "name": "Szybka Przewaga",
    "desc": "Dowolna karta · Prio Control · Koszt 1–2",
    "sourceCategories": [
      "deckArchetypes"
    ],
    "filter": {
  ...
  {
    "id": "choice_skaar_ten_power",
    "type": "choice",
    "rarity": "rare",
    "family": "tag",
    "name": "Dziesięć Ton",
    "desc": "Dowolna karta · Skaar · Siła 10+",
    "sourceCategories": [
      "deckArchetypes"
    ],
    "filter": {
  ...
  {
    "id": "choice_ramp_cheap_core",
    "type": "choice",
    "rarity": "rare",
    "family": "tag",
    "name": "Zapłon Rampy",
    "desc": "Dowolna karta · Ramp · Koszt 2–3",
    "sourceCategories": [
      "deckArchetypes"
    ],
    "filter": {
  ...
  {
    "id": "choice_surfer_three_cost",
    "type": "choice",
    "rarity": "rare",
    "family": "tag",
    "name": "Trójkowa Fala",
    "desc": "Dowolna karta · Surfer / Buff · Koszt 3",
    "sourceCategories": [
      "deckArchetypes"
    ],
    "filter": {
